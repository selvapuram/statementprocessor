...
/**
 * The Interface ValidateAccountService.
 * This Interface is used to validate the customer statement based on request
 */
public interface ValidateAccountService {

  Records validateAccount(AcceptedFileType fileType) throws Exception;
}
